...
Hallar $\alpha$ y $\beta$ para que $x^5-\alpha x+\beta$ sea divisible entre $x^2-4$, y $\alpha$ y $\beta$ no dependan de $x$.

## Pregunta 3

Hallar $\alpha$ y $\beta$ para que $x^3-\alpha x^2+\beta x+3$ sea divisible entre $x^2+x+1$, y $\alpha$ y $\beta$ no dependan de $x$.
