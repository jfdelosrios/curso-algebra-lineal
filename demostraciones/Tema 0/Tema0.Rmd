...
Empecemos por la unicidad de 0. Para ello, supongamos que existen dos números $0,\tilde{0}\in\mathbb{K}$, $0\ne\tilde{0}$ para los cuales se cumplen:
...
Pasemos ahora a ver lo mismo para el neutro del producto. De nuevo, supongamos que existen dos números $1,\tilde{1}\in\mathbb{K}$, $1\ne\tilde{1}$ para los cuales se cumplen las definiciones de elemento neutro.
