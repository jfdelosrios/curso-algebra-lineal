...
<l class = "definition">Conjugado de z.</l> Si $z=a+bi$, entonces $\bar{z}=a-bi$

<l class = "definition">Módulo.</l> $|z|=\sqrt{z\cdot\bar{z}}$

<l class = "definition">Argumento.</l> Si $z=a+bi$, entonces  $\text{arg}(z)=\arctan\left(\frac{b}{a}\right)$. Se da en radianes.
